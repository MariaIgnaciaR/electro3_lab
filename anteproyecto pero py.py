...
class MonitorProfesional(QMainWindow):
    def __init__(self):
        ...
        self.eje_fechas = pg.DateAxisItem(orientation='bottom')
        self.grafica_historial_widget = pg.PlotWidget(axisItems={'bottom': self.eje_fechas})
        ...
        # ★ INICIALIZAR COMBOBOX SEÑAL (Tab 4)
        self.comboBox_senal.clear()
        self.comboBox_senal.addItems(["Temperatura", "ECG", "Pulso"])
    ...
    def ir_a_editar_paciente_desde_busqueda(self):
        ...
        self._log(f"[BD] Modo edición activado para paciente ID: {p['id_paciente']}. Redirigido a formulario.")
    ...
    def graficar_historial(self):
        ...
        # Ya NO necesitamos setAxisItems porque se configuró en el __init__
        # Ajustar rango Y
        ...
        stats_text = pg.TextItem(
            ...
            color=(50, 50, 50),
            anchor=(0, 1)  # Anclado arriba a la izquierda
        )
        stats_text.setFont(QtGui.QFont("Arial", 10, QtGui.QFont.Bold))
        stats_text.setPos(fechas_np[0], y_max)  # Primera fecha, arriba del todo
    ...
    def limpiar_historial(self):
        ...
        self.comboBox_senal.setCurrentIndex(0) # Esta es la línea que faltaba
